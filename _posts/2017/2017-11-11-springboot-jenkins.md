...
![](http://www.hlbhcz.com/assets/images/2017/jenkins/1.png)
...
![](http://www.hlbhcz.com/assets/images/2017/jenkins/2.png)

接下来是进入插件安装进度界面:

![](http://www.hlbhcz.com/assets/images/2017/jenkins/3.png)


插件一次可能不会完全安装成功，可以点击Retry再次安装。直到全部安装成功

![](http://www.hlbhcz.com/assets/images/2017/jenkins/32.png)

等待一段时间之后，插件安装完成，配置用户名密码:

![](http://www.hlbhcz.com/assets/images/2017/jenkins/4.png)

输入：admin/admin

系统管理-》全局工具配置  jdk路径，

![](http://www.hlbhcz.com/assets/images/2017/jenkins/5.png)
...
![](http://www.hlbhcz.com/assets/images/2017/jenkins/6.png)
...
![](http://www.hlbhcz.com/assets/images/2017/jenkins/7.png)

**Maven**

配置本地maven的路径，去掉勾选自动安装

![](http://www.hlbhcz.com/assets/images/2017/jenkins/8.png)
...
![](http://www.hlbhcz.com/assets/images/2017/jenkins/9.png)
...
![](http://www.hlbhcz.com/assets/images/2017/jenkins/10.png)

下方选择构建一个maven项目，点击确定。

勾选**丢弃旧的构建**，选择是否备份被替换的旧包。我这里选择备份最近的10个

![](http://www.hlbhcz.com/assets/images/2017/jenkins/12.png)

源码管理,选择svn,配置SVN相关信息，点击add可以输入svn的账户和密码

![](http://www.hlbhcz.com/assets/images/2017/jenkins/11.png)

svn地址：http://192.168.0.xx/svn/xxx@HEAD,```@HEAD```意思取最新版本

构建环境中勾选“Add timestamps to the Console Output”，代码构建的过程中会将日志打印出来

![](http://www.hlbhcz.com/assets/images/2017/jenkins/13.png)
...
![](http://www.hlbhcz.com/assets/images/2017/jenkins/14.png)

Post Steps 选择 Run only if build succeeds 

![](http://www.hlbhcz.com/assets/images/2017/jenkins/15.png)

点击**Add post-build step**，选择 Send files or execute commands over SSH

![](http://www.hlbhcz.com/assets/images/2017/jenkins/16.png)

Name选择上面配置的Push SSH

![](http://www.hlbhcz.com/assets/images/2017/jenkins/17.png)
