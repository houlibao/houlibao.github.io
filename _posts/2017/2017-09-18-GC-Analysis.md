...
简单总结一下，Java GC就是通过GC收集器回收不在存活的对象，保证JVM更加高效的运转。如果不了解GC算法和垃圾回收器可以参考这篇文章：[jvm系列(三):GC算法 垃圾收集器](http://www.yvantan.com/jvm/2017/08/29/GC-garbage-collection.html)。
...
更详细的内容参考这篇文章：[jvm系列(四):jvm调优-命令篇](http://www.yvantan.com/jvm/2017/09/03/jvm-command.html)
...
Young GC日志:
![](http://yvantan.com/assets/images/2017/jvm/Young GC.png)

Full GC日志:
![](http://yvantan.com/assets/images/2017/jvm/Full GC.png)
...
![](http://www.yvantan.com/assets/images/2017/jvm/g1.jpg)

- GC Pause Stats:可以查看GC 的次数、GC的时间、GC的开销、最大GC时间和最小GC时间等，以及相应的柱状图

 
![](http://www.yvantan.com/assets/images/2017/jvm/g2.jpg)
...
![](http://www.yvantan.com/assets/images/2017/jvm/g3.jpg)
...
![](http://www.yvantan.com/assets/images/2017/jvm/gceasy1.png)

 
![](http://www.yvantan.com/assets/images/2017/jvm/gceasy2.png)
