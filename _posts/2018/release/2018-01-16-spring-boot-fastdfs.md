...
上篇文章介绍了[如何使用Spring Boot上传文件](http://www.hlbhcz.com/springboot/2018/01/12/spring-boot-upload-file.html)，这篇文章我们介绍如何使用Spring Boot将文件上传到分布式文件系统FastDFS中。
...
![](http://www.hlbhcz.com/assets/images/2018/fastdfs/fastDfs_sucees.png)

在浏览器中访问此Url，可以看到成功通过FastDFS展示：

![](http://www.hlbhcz.com/assets/images/2018/fastdfs/fastDfs_pic.png)
